...
UPDATE application.request_type SET status = 'x' WHERE code = 'cadastrePrint';
...
UPDATE application.request_type SET status = 'x' WHERE code = 'documentCopy';
...
UPDATE application.request_type SET status = 'c' WHERE code = 'newFreehold';
UPDATE application.request_type SET status = 'c' WHERE code = 'newOwnership';
...
UPDATE application.request_type SET status = 'c' WHERE code = 'registerLease';
...
UPDATE application.request_type SET status = 'x' WHERE code = 'subdividedProperty';
