...
INSERT INTO system.br_validation(br_id, target_code, target_service_moment, target_request_type_code, severity_code, order_of_execution)
    VALUES ('survey-plan-cleared-by-planning', 'service', 'complete', 'newParcel', 'critical', 140);

INSERT INTO system.br_validation(br_id, target_code, target_service_moment, target_request_type_code, severity_code, order_of_execution)
    VALUES ('survey-plan-cleared-by-planning', 'service', 'complete', 'existingParcel', 'critical', 150);
...
INSERT INTO system.br_validation(br_id, target_code, target_service_moment, target_request_type_code, severity_code, order_of_execution)
    VALUES ('survey-plan-cleared-by-environment', 'service', 'complete', 'newParcel', 'critical', 160);

INSERT INTO system.br_validation(br_id, target_code, target_service_moment, target_request_type_code, severity_code, order_of_execution)
    VALUES ('survey-plan-cleared-by-environment', 'service', 'complete', 'existingParcel', 'critical', 170);
