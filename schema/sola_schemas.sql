...
CREATE TABLE cadastre_object (
    ...
    licensed_surveyor_id character varying(40),
    ...
    environment_clearance boolean DEFAULT false,
    planning_clearance boolean DEFAULT false,
...
--
-- Name: COLUMN cadastre_object.environment_clearance; Type: COMMENT; Schema: cadastre; Owner: postgres
--

COMMENT ON COLUMN cadastre_object.environment_clearance IS 'Flag indicating that Environment clearance received. True - received, False - not received.';


--
-- Name: COLUMN cadastre_object.planning_clearance; Type: COMMENT; Schema: cadastre; Owner: postgres
--

COMMENT ON COLUMN cadastre_object.planning_clearance IS 'Flag indicating that Planning clearance received. True - received, False - not received.';
...
CREATE VIEW chief AS
 SELECT s.id,
    s.label,
    s.geom
   FROM spatial_unit_group s
  WHERE (s.hierarchy_level = 3);
...
ALTER TABLE chiefdom OWNER TO postgres;

--
-- Name: chiefdoms_type; Type: TABLE; Schema: cadastre; Owner: postgres
--
...
ALTER TABLE chiefdoms_type OWNER TO postgres;
...
CREATE VIEW dist AS
 SELECT s.id,
    ...
    s.geom
   FROM spatial_unit_group s
  WHERE (s.hierarchy_level = 2);


ALTER TABLE dist OWNER TO postgres;
...
--
-- Name: land_type; Type: TABLE; Schema: cadastre; Owner: postgres
--
...
ALTER TABLE land_type OWNER TO postgres;
...
CREATE VIEW reg AS
 SELECT s.id,
    ...
    s.geom
   FROM spatial_unit_group s
  WHERE (s.hierarchy_level = 1);


ALTER TABLE reg OWNER TO postgres;
...
CREATE VIEW sect AS
 SELECT s.id,
    ...
    s.geom
   FROM spatial_unit_group s
  WHERE (s.hierarchy_level = 4);


ALTER TABLE sect OWNER TO postgres;
...
CREATE VIEW survey_plan_view AS
 SELECT sp.id,
   ...
   FROM transaction.transaction tt,
  ...
  WHERE (((sp.land_type)::text <> 'state_land'::text) AND ((sp.transaction_id)::text = (tt.id)::text) AND ((tt.from_service_id)::text = (ss.id)::text) AND ((ss.request_type_code)::text = 'newParcel'::text))
  ORDER BY sp.id;


ALTER TABLE survey_plan_view OWNER TO postgres;
...
--
-- Name: survey_type; Type: TABLE; Schema: cadastre; Owner: postgres
--
...
--
-- Name: surveying_method_type; Type: TABLE; Schema: cadastre; Owner: postgres
--
...
ALTER TABLE surveying_method_type OWNER TO postgres;
...
--
-- Name: cordinate_system_type; Type: TABLE; Schema: system; Owner: postgres
--
...
ALTER TABLE cordinate_system_type OWNER TO postgres;
...
--
-- Name: chiefdoms_display_value_unique; Type: CONSTRAINT; Schema: cadastre; Owner: postgres
--
...
--
-- Name: chiefdoms_pkey; Type: CONSTRAINT; Schema: cadastre; Owner: postgres
--
...
--
-- Name: land_type_display_value_unique; Type: CONSTRAINT; Schema: cadastre; Owner: postgres
--
...
--
-- Name: land_type_pkey; Type: CONSTRAINT; Schema: cadastre; Owner: postgres
--
...
--
-- Name: survey_type_display_value_unique; Type: CONSTRAINT; Schema: cadastre; Owner: postgres
--
...
--
-- Name: survey_type_pkey; Type: CONSTRAINT; Schema: cadastre; Owner: postgres
--
...
--
-- Name: surveying_method_display_value_unique; Type: CONSTRAINT; Schema: cadastre; Owner: postgres
--
...
--
-- Name: surveying_method_pkey; Type: CONSTRAINT; Schema: cadastre; Owner: postgres
--
...
--
-- Name: cordinate_system_display_value_unique; Type: CONSTRAINT; Schema: system; Owner: postgres
--
...
--
-- Name: cordinate_system_pkey; Type: CONSTRAINT; Schema: system; Owner: postgres
--
