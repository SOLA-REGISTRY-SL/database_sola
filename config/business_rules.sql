...
INSERT INTO br_definition (br_id, active_from, active_until, body) VALUES ('app_on_approve_check_SP', '2016-01-01', 'infinity', 'SELECT (COUNT(*) > 0)  AS vl
...
INSERT INTO br_validation (id, br_id, target_code, target_application_moment, target_service_moment, target_reg_moment, target_request_type_code, target_rrr_type_code, severity_code, order_of_execution) VALUES ('01b6539e-2ee5-11e6-93c1-4ba434d5341b', 'app_on_approve_check_SP', 'application', 'approve', NULL, NULL, NULL, NULL, 'critical', 722);
