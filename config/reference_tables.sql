...
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('newParcel', 'registrationServices', 'New survey plan for Private Land', '', 'c', 1, 25.00, 0.10, 0.00, 0, NULL, NULL, NULL, 'cadastreTransMap', 'survey', 399);
...
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('newParcelSL', 'registrationServices', 'New survey plan for State Land', '', 'c', 1, 25.00, 0.10, 0.00, 0, NULL, NULL, NULL, 'cadastreTransMap', 'survey', 399);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('existingParcelSL', 'registrationServices', 'Existing survey plan for State Land', '', 'c', 1, 25.00, 0.10, 0.00, 0, NULL, NULL, NULL, 'cadastreTransMap', 'survey', 399);
INSERT INTO request_type (code, request_category_code, display_value, description, status, nr_days_to_complete, base_fee, area_base_fee, value_base_fee, nr_properties_required, notation_template, rrr_type_code, type_action_code, service_panel_code, display_group_code, display_order) VALUES ('existingParcel', 'registrationServices', 'Existing survey plan for Private Land', '', 'c', 1, 25.00, 0.10, 0.00, 0, NULL, NULL, NULL, 'cadastreTransMap', 'survey', 400);
...
INSERT INTO administrative_source_type (code, display_value, status, description, is_for_registration) VALUES ('other', 'Other::::::::::::::::::::::::', 'c', 'Document that does not fit one of the other named categories.::::::::::::::::::::::::', false);
...
INSERT INTO administrative_source_type (code, display_value, status, description, is_for_registration) VALUES ('surveyDataFile', 'Survey Data File::::::::::::::::::::::::', 'c', 'A CSV data file containing survey coordinate points that can be imported when processing the Change to Cadastre Service.::::::::::::::::::::::::', false);
INSERT INTO administrative_source_type (code, display_value, status, description, is_for_registration) VALUES ('taxPayment', 'Survey Bill', 'c', 'Receipt confirming payment for Service', false);
INSERT INTO administrative_source_type (code, display_value, status, description, is_for_registration) VALUES ('cadastralMap', 'Master Plan', 'c', 'Extension to LADM::::Расширение LADM::::ميزة إضافية للنظام::::Extension au LADM::::Extension a LADM::::Extensão para LADM::::扩展为 LADM', false);
...
INSERT INTO administrative_source_type (code, display_value, status, description, is_for_registration) VALUES ('applicationletter', 'Application Letter for State Land', 'c', 'Application Letter/document to Minister for a State Land', true);
INSERT INTO administrative_source_type (code, display_value, status, description, is_for_registration) VALUES ('offerletterfrommlcpe', 'Offer Letter from MLCPE', 'c', 'Offer Letter from MLCPE for State Lands', true);
INSERT INTO administrative_source_type (code, display_value, status, description, is_for_registration) VALUES ('acceptanceletter', 'Acceptance Letter', 'c', 'Acceptance Letter from MLCPE indicating the approval of the State Land Request', true);
INSERT INTO administrative_source_type (code, display_value, status, description, is_for_registration) VALUES ('initialsurveybymlcpe', 'Initial Survey by MLCPE', 'c', 'Payment of initial rents for State Lands', true);
INSERT INTO administrative_source_type (code, display_value, status, description, is_for_registration) VALUES ('receiptofpayment', 'Receipt of Payment', 'c', 'Payment of initial rent(s) for State Lands', true);
...
INSERT INTO administrative_source_type (code, display_value, status, description, is_for_registration) VALUES ('fieldSketch', 'Survey DataSheet', 'c', 'sketch from the field', false);
...
INSERT INTO approle (code, display_value, status, description) VALUES ('StateLandClearance', 'State Land Clearance', 'c', 'Role used to give clearance for private land survey plan before approval.');
...
INSERT INTO approle (code, display_value, status, description) VALUES ('newParcelSL', 'Service - New survey plan for State Land', 'c', '"Survey Service. Allows New survey plan service to be started.');
INSERT INTO approle (code, display_value, status, description) VALUES ('existingParcelSL', 'Service - Existing survey plan for State Land', 'c', '"Survey Service. Allows Existing survey plan for State Land service to be started.');
...
INSERT INTO approle (code, display_value, status, description) VALUES ('ManageSurveyPlan', 'Create/edit survey plans', 'c', 'Role used to create or edit survey plans.');
INSERT INTO approle (code, display_value, status, description) VALUES ('PlanningClearance', 'Planing Clearance', 'c', 'Role used to give planing clearance for private land survey plan before approval.');
INSERT INTO approle (code, display_value, status, description) VALUES ('EvironmentClearance', 'Environment Clearance', 'c', 'Role used to give environment clearance for private land survey plan before approval.');
...
INSERT INTO approle (code, display_value, status, description) VALUES ('existingParcel', 'Existing survey plan', 'c', '');
